...
## 更新摘要
**变更内容**
- Ruby安装脚本新增多源下载机制，支持gh-proxy.com、ghfast.top、github.com三个下载源
- 增强下载可靠性，采用并行测速选择最优下载源
- 添加UTF-8支持和PATH环境变量配置，通过Inno Setup参数启用defaultutf8和modpath任务
- 改进版本管理，Ruby版本固定为4.0.5-1
- 增强错误处理，包含下载失败和安装失败的详细错误信息
- 优化用户界面消息，提供更清晰的进度反馈和状态提示
...
InstallRuby[install_2_ruby_bywin.ps1<br/>Ruby + Devkit安装<br/>新增多源下载机制]
InstallFastlane[install_3_fastlane_bywin.ps1<br/>Fastlane安装]
end
...
- [scripts/windows/install_2_ruby_bywin.ps1:1-138](file://scripts/windows/install_2_ruby_bywin.ps1#L1-L138)
...
这套 PowerShell 自动化系统不仅提高了开发效率，更为项目的长期维护奠定了坚实的基础，是现代跨平台开发项目的优秀范例。新增的完整脚本生态系统进一步增强了系统的实用性和完整性，为开发者提供了从环境搭建到应用发布的全流程自动化解决方案。特别是Ruby安装脚本的重大改进，为Android应用构建提供了更加稳定可靠的Ruby运行环境，是整个自动化系统的重要里程碑。